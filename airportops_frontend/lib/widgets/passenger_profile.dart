                            ...
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(color: passenger.status.color, width: 8)
                                ),
                    ...
                    child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              const Text('Traveler Details', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20)),
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.fromLTRB(25, 12, 5, 5),
                                    child: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Row(
                                              children: const [
                                                Text('Citizenship: ', style: myStyle),
                                                Text('United States'),
                                              ]
                                          ),
                                          Row(
                                              children: [
                                                ...
                                                Text(passenger.birthday.toString().split(' ')[0])
                                              ]
                                          ),
                                          Row(
                                              children: const [
                                                Text('Fare Type: ', style: myStyle),
                                                Text('United Polaris®')
                                              ]
                                          )
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      children: [
                                        Text("Seat", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
                                        SizedBox(height: 5),
                                        Text(passenger.seat.toString() + "-" + passenger.row.toString(), style: TextStyle(color: Colors.red))
                                      ]
                                    )
                                  )
                                ]
